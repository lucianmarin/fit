# What is the Spermidine Diet?

The Spermidine Diet is a way of eating designed to raise spermidine through two complementary routes: **direct intake** and **indirect production**.

### Direct route: eat spermidine-rich and fermented foods

The most direct way to increase spermidine is to eat foods that naturally contain high amounts of this polyamine. Some of the richest sources include wheat germ, aged cheeses, soybeans, natto, tempeh, mushrooms, legumes, whole grains, green peas, broccoli, cauliflower, mango, and chicken liver.

Fermented foods are especially important because bacterial fermentation can increase polyamine content while also introducing beneficial microbes and organic acids. Examples include natto, tempeh, miso, yogurt, kefir, cultured buttermilk, sauerkraut, kimchi, naturally fermented pickles, and aged cheeses. These foods can contribute spermidine directly while also supporting the broader gut ecosystem.

### Indirect route: feed spermidine-producing gut bacteria with fiber

High-fiber foods help raise spermidine indirectly by feeding gut bacteria that can synthesize polyamines. Dietary fiber is not only fuel for your own digestion; it is also fermentable substrate for colonic bacteria — notably *Bacteroides* and *Fusobacterium* species — that produce spermidine and putrescine.

Animal studies using fermentable fibers, such as pectin, have shown higher cecal spermidine output, suggesting that increasing fiber intake can help the gut make more spermidine on top of the spermidine consumed directly from food.

### Why high-fiber and fermented foods work together

The Spermidine Diet is best understood as three overlapping food categories:

1. **High-spermidine foods** — wheat germ, aged cheese, soy products, mushrooms, legumes, whole grains, cruciferous vegetables, and select animal foods such as chicken liver.  
2. **Fermented foods** — natto, tempeh, miso, yogurt, kefir, sauerkraut, kimchi, and aged cheeses, which can provide fermentation-derived polyamines and beneficial microbes.  
3. **High-fiber foods** — legumes, bran, seeds, whole grains, vegetables, and fruits, which feed polyamine-producing gut bacteria.

When high-fiber foods are paired with fermented foods — for example, oats with kefir, beans with aged cheese, whole-grain toast with natto, or roasted broccoli with kimchi — the pattern becomes synbiotic-like: prebiotic fiber feeds the microbes, while fermented foods supply microbes and fermentation-derived metabolites. Together, they may help raise spermidine exposure more effectively than either approach alone.
...
| --- | --- | --- |
| Wheat germ | 24–44 | Highest common food source; varies with milling/processing |
| Aged hard cheese (cheddar 12+ mo, parmesan) | up to 20 | Rises with aging/fermentation time |
| Dried soybeans, natto, tempeh | 10–30 | Fermented forms (natto, tempeh) trend higher |
| Mushrooms (shiitake, oyster, etc.) | ~9 | Varies notably by species |
| Green peas, cooked | ~6.5 | |
| Chicken liver | ~5 | Highest common animal source besides aged cheese |
| Black tea (leaves) | ~3.8 | Per spermidinefoods.com database |
| Broccoli / cauliflower | 3–4 | |
| Mango | ~3 | |
| Celeriac | ~2.7 | |
| Whole grains (brown rice, corn) | 1–5 | |
...
Fermentation deserves its own table because it acts on spermidine from both sides at once: it raises the polyamine content of the food itself through microbial biosynthesis, and it seeds the gut with live microbes that keep synthesizing polyamines after the meal is over.

### Fermentation raises the polyamine content of the food itself
Bacterial and fungal fermentation is not neutral with respect to spermidine — in many foods it measurably increases it. Fermented soy products such as natto can reach around 20 mg of spermidine per 100 g through microbial biosynthesis. In direct analyses of fermented versus non-fermented soy products, natto and tempeh showed the highest polyamine contents, at 75–124 mg/kg of spermidine. Koji fermentation of rice bran with *Aspergillus oryzae* increased spermidine content to 158% of the unfermented starting material. Yeast fermentation of garlic likewise significantly increased total polyamines and shifted the spermine/spermidine balance. Even fish has been shown to gain spermidine after fermentation. In dairy, polyamine content rises with ripening time, and matured hard cheeses approach ~20 mg/100 g while fresh dairy stays low. And in vegetable ferments, the lactic acid bacteria (LAB) behind sauerkraut, kimchi, and pickles produce putrescine and spermidine as part of their acid-stress biology, adding microbial polyamines to vegetables that started with less.

### Human trials: eating fermented foods raises blood polyamines
The food-table increases are not just chemistry — they show up in human blood. Healthy volunteers eating a mean of ~66 g of natto per day for two months raised their whole-blood spermine concentration by a factor of about 1.39. A longer intervention by the same group found that a polyamine-rich natto diet elevated blood spermine and inhibited pro-inflammatory status. The landmark 2018 *Science* review by Madeo et al. cites these natto trials as direct evidence that polyamines from fermented food reach the human circulation. One nuance worth keeping in mind: in a recent controlled trial, natto consumption raised whole-blood spermine while blood spermidine itself remained unchanged, so the circulating response may show up more strongly as spermine (partly converted from ingested spermidine) than as spermidine per se.

### The indirect route: fermented foods feed a polyamine-producing microbiome
Fermented foods also raise spermidine indirectly by remodeling the ecosystem that makes it for you. A 10-week diet high in fermented foods increased gut microbiome diversity and decreased inflammatory markers in a Stanford randomized trial. That matters because gut microorganisms — including *Bacteroides* and *Fusobacterium* species and many LAB — synthesize putrescine, spermidine, and spermine at millimolar concentrations in the colon. And microbially produced spermidine is not merely local: probiotic-derived spermidine has been shown to accumulate in the gut and be transported to host tissues such as the liver. Paired with the prebiotic fiber in the tables above, live ferments create a synbiotic effect — the fiber feeds the polyamine-producing bacteria that the ferments help supply.

### Fermented Foods Table

| Fermented food | Spermidine (mg / 100 g) | Notes |
| --- | --- | --- |
| Natto (fermented soybeans) | 11–27 | Microbial biosynthesis puts it among the top spermidine foods; ~2 months of daily intake raised blood spermine ~1.4× in human volunteers |
| Tempeh | 7.5–12.5 (up to ~21 in some analyses) | *Rhizopus* fungal fermentation; among the highest polyamine contents measured in soy |
| Miso | Varies (soy-derived) | Fermented soy paste in the same high-spermidine family as natto and tempeh |
| Aged hard cheese (cheddar, parmesan, gouda) | Up to ~20 | Polyamine content rises with ripening/fermentation time; matured cheeses had the highest polyamine content of dairy products |
| Koji-fermented rice bran (amazake, shio koji) | +158% vs. unfermented | *A. oryzae* fermentation measurably increases spermidine |
| Yeast-fermented garlic | Increased vs. raw | Fermentation significantly raises total polyamines |
| Sauerkraut, kimchi, fermented pickles | Low–moderate; rises with fermentation | LAB synthesize putrescine/spermidine during acid fermentation |
| Yogurt, kefir, cultured buttermilk | Modest, plus live cultures | Supply polyamine-producing probiotic strains alongside B12 and protein |
| Fermented fish | Increased vs. fresh | Fermentation has been shown to raise spermidine levels |
